...
void timerConfigure(const timerHardware_t *timHw, timCCR_t period, uint8_t mhz);  // This interface should be replaced.
...
void configTimeBase(TIM_TypeDef *tim, timCCR_t period, uint8_t mhz);  // TODO - just for migration
